## file to do the 3-screen method specifically for the MW926, MW927 and MW930 file
...
curdr = os.getcwd()
csvpath = os.path.join(curdr,'three_screen_data_file2.csv')
...
figpath = os.path.join(curdr,'new_three_screen_figures_file2')
...
newdata2 = data2[18:-1]
newxdata2 = basexdata[18:-1]
#slice off last 18 pnts
newdata2 = newdata2[0:-18]
newxdata2 = newxdata2[0:-18]
...
# data3
#slice off first 2 points
newdata3 = data3[3:-1]
newxdata3 = basexdata[3:-1]
#slice off last 25 pnts
newdata3 = newdata3[0:-26]
newxdata3 = newxdata3[0:-26]
...
# plt.show()
row = pd.DataFrame(np.array([[alphax1,betax1,epsx1]]),index=['file'+'2'+' x '+'scipy'],columns=col)
...
# plt.show()
row = pd.DataFrame(np.array([[alphax2[0],betax2[0],epsx2[0]]]),index=['file'+'2'+' x '+'gekko'],columns=col)
datacsv = pd.concat([datacsv,row])
...
# slice off first 18 points
newdata1 = data1[18:-1]
newydata1 = baseydata[18:-1]
# slice off last 13
newdata1 = newdata1[0:-17]
newydata1 = newydata1[0:-17]
...
# data2
data2 = data2 - 0.02
#slice off first 15 points
newdata2 = data2[15:-1]
newydata2 = baseydata[15:-1]
#slice off last 14 pnts
newdata2 = newdata2[0:-14]
newydata2 = newydata2[0:-14]
...
newdata3 = data3[12:-1]
newydata3 = baseydata[12:-1]
#slice off last 3 pnts
newdata3 = newdata3[0:-3]
newydata3 = newydata3[0:-3]
...
# plt.show()
row = pd.DataFrame(np.array([[alphay1,betay1,epsy1]]),index=['file'+'2'+' y '+'scipy'],columns=col)
datacsv = pd.concat([datacsv,row])
...
# plt.show()
row = pd.DataFrame(np.array([[alphay2[0],betay2[0],epsy2[0]]]),index=['file'+'2'+' y '+'gekko'],columns=col)
datacsv = pd.concat([datacsv,row])
